...
<div class="ctr_box02">
   ...
   <div class="scs_ctr_bg">
     <div class="reg">
       ...
       <div class="reg_scs">
          <div class="wt_box_sty01">已将激活邮件发送到您的邮箱：</div>
 ...
 进入邮箱激活，即可完成注册。</div>
       ...
       <div class="reg_explain">
          <dd>没收到验证邮件？</dd>
         <dt>1. 尝试到垃圾邮件里找找看或<a href="<%=contextPath%>/email_ag.action?email=<%=str%>">再次发送验证邮件</a>。<br />2. 如果重发验证邮件仍没有收到，请<a href="http://zhuanjia.haufe.cn/register">重新注册</a><br />3. 邮件服务器延迟，请稍后查看</a></dt>
       </div>
     </div>
   </div>
