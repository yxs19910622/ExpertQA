...
<meta http-equiv="refresh" content="5;URL=http://zhuanjia.haufe.cn" />
<title>浩富</title>
...
<body>
<!--header_logo start-->
<div id="header_logo"><a href="http://www.haufe.cn/"><img src="<%=contextPath%>/haufe/images/logo.jpg" alt="浩富 用户中心" /></a></div>
<!--header_logo end-->
<!--Registration start-->
<div class="ctr_box02">
   ...
   <div class="scs_ctr_bg">
     <div class="reg">
       ...
       <div class="reg_scs">
          <div class="wt_box_sty01">恭喜您通过邮箱验证,您已获得7天免费试用</div>
          <div class="wt_box_sty02">本页面将在5秒后自动跳转到首页或<a href="http://www.haufe.cn" ><font color="blue">点击手动跳转</font></a>
 			</div>
       </div>
     </div>
   </div>
