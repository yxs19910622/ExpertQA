...
var addressInit = function(_province, _city, _county, defaultProvince, defaultCity, defaultArea)
{
	var province = document.getElementById(_province);
	var city = document.getElementById(_city);
	var county = document.getElementById(_county);
