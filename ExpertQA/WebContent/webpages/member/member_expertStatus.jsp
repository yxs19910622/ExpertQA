...
<jsp:param value="expertStatus" name="currOpt"/>
</jsp:include>
...
<!--                      <tr>
						...
						<tr>
                        <td style="height:30px" align="right">适用产品：
                        	<!-- <input type="text" name="applicableproduct"/> -->
                        	<td style="position:absolute;clip: rect(6 17 17 6)" align="right">
								<input type="checkbox" name="applicableproduct" value="P0003">浩富劳动法顾问软件(标准版)
	                        	<input type="checkbox" name="applicableproduct" value="P0001">浩富劳动法实务手册(标准版)
								<input type="checkbox" name="applicableproduct" value="P0002">浩富劳动法顾问软件(专业版)
								<input type="checkbox" name="applicableproduct" value="P0004">浩富劳动法专家咨询(标准版)
							</td>
