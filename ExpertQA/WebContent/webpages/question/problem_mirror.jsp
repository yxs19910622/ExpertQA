...
function showQuestionContent(){
	...
	questionAbs.getOneQuestion(questionId,function(question){
        ...
        var html = '<dl>';
            ...
            html += '<img src="<%=contextPath%>/'+question.USERPICTURE+'.jpg" alt="" />';
            }else{
            html += '<img src="<%=contextPath%>/upload/pic/iface.jpg" alt="" />';
            } 
        ...
        var otherhtml = '<div class="other_da"><h4>其他回答</h4>';
         for(var i = 0;i < list.length; i++){
             if(list[i].ISTOP == '1'){//expert ok answer
            	 ...
            	 okhtml += '<img src="<%=contextPath%>/'+list[i].USERPICTURE+'.jpg" alt="" />';
                 }else{
                 okhtml += '<img src="<%=contextPath%>/upload/pic/iface.jpg" alt="" />';
                 }
            	 ...
            	 otherhtml += '<dt>';
            	 if(list[i].USERPICTURE != undefined){
            	 otherhtml += '<img src="<%=contextPath%>/'+list[i].USERPICTURE+'.jpg" alt="" />';
                 }else{
                 otherhtml += '<img src="<%=contextPath%>/upload/pic/iface.jpg" alt="" />';
                 }
...
<body>
	<jsp:include page="/common/head_mirror.jsp"><jsp:param name="indexPage" value="index" />
    </jsp:include>
    <div class="margin">
