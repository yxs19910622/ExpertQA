...
function getQuestionsListBack(list){
	...
	for(var i=0;i<list.length-1;i++){  
     html += '<dl>';		
     html += '<dt><a href="javascript:(void);" onclick="viewAnswerHref(\'answerQuestion_mirror?questionid='+list[i].QUESTIONID+'\')">'+list[i].CAPTIONTEXT+'</a></dt>';
     html += '<dd>';
     ...
     if(list[i].ISALREADYCLOSED == "0"){
        // alert(oper);
         ...
         html += '<a href="javascript:(void);" class="zhuanjia_deng" onclick="viewAnswerHref(\'answerQuestion_mirror?questionid='+list[i].QUESTIONID+'\')">专家回答</a>';
