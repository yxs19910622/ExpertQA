...
<!-- 百度分享 -->
<%-- <script type="text/javascript" id="bdshare_js" data="type=button&amp;uid=6862032" ></script>
...
function showQuestionContent(){
	questionAbs.getOneQuestion(questionId,function(question){
        ...
        var html = '<dl>';
            ...
            html += '<a href="javascript:(void);"><img src="<%=contextPath%>/'+question.USERPICTURE+'.jpg" alt="" />';
            }else{
            html += '<a href="javascript:(void)"><img src="<%=contextPath%>/upload/pic/iface.jpg" alt="" />';
            } 
        ...
        var otherhtml = '<div class="other_da"><h4>其他回答</h4>';
         for(var i = 0;i < list.length; i++){
             if(list[i].ISTOP == '1'){//expert ok answer
            	 ...
            	 okhtml += '<a target="_blank" href="expert/<s:property value='labuser.userID'/>"><img src="<%=contextPath%>/'+list[i].USERPICTURE+'.jpg" alt="" />';
                 }else{
                 ...
                 okhtml += '<a class="bshareDiv" href="http://www.bshare.cn/share">分享按钮</a>';
            	 ...
            	 otherhtml += '<dt>';
            	 if(list[i].USERPICTURE != undefined){
            	 otherhtml += '<a href="javascript:(void);"><img src="<%=contextPath%>/'+list[i].USERPICTURE+'.jpg" alt="" />';
                 }else{
            	 ...
            	 otherhtml += '<div id="bdshare" class="bdshare_b" style="line-height: 12px;"><img src="http://bdimg.share.baidu.com/static/images/type-button-1.jpg?cdnversion=20120831" /></div>';
    ...
    <div class="margin">
    	...
    	<div class="index_left fl">
            <div class="problem_left">
            	<div class="problem_title">专家在线问答&nbsp;&gt;&nbsp;<a href="javascript:(void);" onclick="javascript:history.back(-1);">问题分类</a>&nbsp;&gt;&nbsp;<a id = "qatypename" href="#">劳动合同</a></div>
