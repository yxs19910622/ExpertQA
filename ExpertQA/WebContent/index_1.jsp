         ...
         for(var i = 0;i < list.length; i++){
           ...
           var text = list[i].CAPTIONTEXT;
               if(text.length > 20){
                  ...
                  html += '&nbsp;&nbsp;<a href="javascript:viewAnswerHref(\'answerQuestion_mirror?questionid='+list[i].QUESTIONID+'\')" onclick="" title="'+list[i].CAPTIONTEXT+'">'+text+'</a></li>';
               }else{
                  html += '&nbsp;&nbsp;<a href="javascript:viewAnswerHref(\'answerQuestion_mirror?questionid='+list[i].QUESTIONID+'\')" onclick="">'+text+'</a></li>';
               }
         }
         ...
         for(var i = 0;i < list.length; i++){
           var name = list[i].ALIASNAME;
              ...
              var text = list[i].CAPTIONTEXT;
                  if(text.length > 20){
                     text = text.substr(0,18)+'...';
                     html2 += '&nbsp;&nbsp;<a href="javascript:viewAnswerHref(\'answerQuestion_mirror?questionid='+list[i].QUESTIONID+'\')" onclick=""  title="'+list[i].CAPTIONTEXT+'">'+text+'</a></li>';
                  }else{
                     html2 += '&nbsp;&nbsp;<a href="javascript:viewAnswerHref(\'answerQuestion_mirror?questionid='+list[i].QUESTIONID+'\')" onclick="">'+text+'</a></li>';
                  }  
         }
...
<body>
<div ><jsp:include page="/common/head_mirror.jsp"><jsp:param name="indexPage" value="index" />
</jsp:include></div> 
...
<div class="index_left fl">
	...
	<jsp:include page="/webpages/index/index_question_mirror.jsp"/>
	</div>
</div>
<div class="index_right fr" style="display:none;">
